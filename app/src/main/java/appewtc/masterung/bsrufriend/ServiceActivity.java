...
public class ServiceActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    private boolean aBoolean = true; // ForStopLoop
    ...
    private void afterResume() {
        ...
        Location gpsLocation = myFindLocation(LocationManager.NETWORK_PROVIDER);
        if (gpsLocation != null) {
        ...
        Log.d("17", "Lat => " + userLatADouble);
        Log.d("17", "Lng => " + userLngADouble);
